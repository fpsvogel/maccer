...
Converts hyphens following vowels into macrons, in all macronized texts.
...
for header,text in pairs(textstbl) do
	macra.backup(text, filenamestbl[header], "hyphens to macrons")
	text = macra.hyphens2macs(text)
